    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate>
                        <i class="bi bi-grid-1x2-fill mx-2"></i>
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            ...
            <div class="hidden md:flex md:items-center md:ms-6">
                <div x-data="{ dark: localStorage.getItem('theme') === 'dark' }" x-init="document.documentElement.classList.toggle('dark', dark)" class="flex items-center">
                    <label class="inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-2 text-xs font-medium text-gray-900 dark:text-gray-300">🌛</span>
                    </label>
                </div>
