    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="mt-5 flex-1 px-2 space-y-1">
            ...
            <a href="{{ route('users.index') }}" wire:navigate
                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('users.index') ? 'bg-blue-100 text-primary dark:bg-blue-900 dark:text-blue-200' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white' }}">
                <i class="bi bi-people-fill mr-3 h-5 w-5"></i>
                {{ __('User Management') }}
            </a>
